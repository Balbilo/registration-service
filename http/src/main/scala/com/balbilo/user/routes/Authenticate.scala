...
import com.balbilo.user.client.{Authorization, Clients}
import com.balbilo.user.json._
import com.balbilo.user.model.{AuthenticationError, UserDetails, UserToken}
import com.balbilo.user.repository.AuthenticationRepository
import com.balbilo.user.service.UserDetailsValidation
